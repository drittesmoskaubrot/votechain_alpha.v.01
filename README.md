VoteChainCoin - an educational cryptocurrency based on SmallChange.
...
http://www.ocf.berkeley.edu/~baisang/VoteChainCoin.pdf
which details the process of using this repository to create your own aVTNoin,
