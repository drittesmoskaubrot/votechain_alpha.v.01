...
uint256 hashGenesisBlock("0xfe9a7b14f86e0dc99cea1191ba985148009afa6ad17e23d72a2fe0df47a63e6c");
...
const string strMessageMagic = "VoteChainCoin Signed Message:\n";
...
{
    int64 nSubsidy = 100000 * COIN; //Amt of coins per block
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // VoteChainCoin: 0.35 days
static const int64 nTargetSpacing = 15; // VoteChainCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal VoteChainCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VoteChainCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfe9a7b14f86e0dc99cea1191ba985148009afa6ad17e23d72a2fe0df47a63e6c");
    }
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "First day of VoteChain";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1474660009;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1049573;
        ...
        assert(block.hashMerkleRoot == uint256("0x97ca5b2432a242551ac28faee2138e563bbd1b06234ad600c7cc32513852b1f7"));
